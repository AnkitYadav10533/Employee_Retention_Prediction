...
# ================= PAGE: ABOUT DEVELOPER =================
    ...
    # 1. Helper to load base64 avatar
    def load_base64_avatar():
        path = "images/dev_avatar.jpg"
        if os.path.exists(path):
            try:
    ...
    # 2. Convert Developer Avatar to Base64
    base64_avatar = load_base64_avatar()

    # 3. HTML Render Content for About Developer
    st.markdown(
        textwrap.dedent(
            f"""
            <div class="fade-in-section">
                ...
                <div class="glass-card" style="text-align: center; padding: 40px 20px;">
                    <div style="position: relative; display: inline-block; margin-bottom: 20px;">
                        <img src="{base64_avatar}" class="profile-avatar-img-about" style="width: 200px; height: 200px; border-radius: 50%; object-fit: cover; border: 4px solid #6366f1; box-shadow: 0 8px 30px rgba(99, 102, 241, 0.3); transition: transform 0.3s ease, box-shadow 0.3s ease;" alt="Ankit Yadav Profile Picture">
                        <style>
                        .profile-avatar-img-about:hover {{
                            transform: scale(1.08) rotate(2deg);
                            box-shadow: 0 12px 35px rgba(99, 102, 241, 0.5) !important;
                        }}
                        </style>
                    </div>
                    <h1 style="font-size: 2.5rem; margin: 0 0 5px 0;">Ankit Yadav</h1>
                    <p style="font-size: 1.2rem; font-weight: 600; color: #818cf8; margin: 0 0 10px 0;">Data Analytics | Machine Learning | AI Enthusiast</p>
                    <p style="font-size: 1.05rem; color: var(--text-secondary); max-width: 650px; margin: 0 auto 15px auto; line-height: 1.4;">
                        B.Tech CSE <br>
                        <b>Shri Ramswaroop Memorial College of Engineering & Management (SRMCEM), Lucknow</b>
                    </p>
                    
                    <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; font-size: 14.5px; color: var(--text-secondary); margin-top: 15px;">
                        <div>📍 Lucknow, Uttar Pradesh, India</div>
                        <div>📧 adityayadav10533@gmail.com</div>
                    </div>
                </div>

                <!-- Lower Layout Grid: Technical Skills & Projects -->
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-top: 24px;">
                    
                    <!-- Left: Skills Card -->
                    <div class="glass-card">
                        <h3 style="margin-top: 0; margin-bottom: 15px; display: flex; align-items: center; gap: 8px;">🛠 Technical Skills</h3>
                        <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                            ...
                            <span class="badge" style="background: rgba(14, 165, 233, 0.1); color: #38bdf8; border-color: rgba(14, 165, 233, 0.3);">SQL</span>
                            <span class="badge" style="background: rgba(139, 92, 246, 0.1); color: #a78bfa; border-color: rgba(139, 92, 246, 0.3);">Git</span>
                            <span class="badge" style="background: rgba(236, 72, 153, 0.1); color: #f472b6; border-color: rgba(236, 72, 153, 0.3);">GitHub</span>
                            <span class="badge" style="background: rgba(244, 63, 94, 0.1); color: #fb7185; border-color: rgba(244, 63, 94, 0.3);">Streamlit</span>
                            <span class="badge" style="background: rgba(100, 116, 139, 0.1); color: #cbd5e1; border-color: rgba(100, 116, 139, 0.3);">Excel</span>
                        </div>
                        
                        <h3 style="margin-top: 30px; margin-bottom: 15px;">💡 Background Summary</h3>
                        <p style="color: var(--text-secondary); line-height: 1.5; font-size: 14px; margin: 0;">
                            I am a computer science undergraduate specializing in B.Tech CSE. My focus lies in data analysis methodologies, designing machine learning models, and building visual frontend dashboards to communicate model predictions and statistical diagnostics.
                        </p>
                    </div>

                    <!-- Right: Projects Card -->
                    <div class="glass-card">
                        <h3 style="margin-top: 0; margin-bottom: 15px; display: flex; align-items: center; gap: 8px;">🏆 Key Projects</h3>
                        <ul style="color: var(--text-secondary); line-height: 1.8; margin-left: 20px; font-size: 14.5px; padding: 0;">
                            <li style="margin-bottom: 12px;">
                                <b>Employee Retention Prediction using Logistic Regression:</b><br>
                                Deployed a premium SaaS diagnostics dashboard integrated with preprocessing pipelines.
                            </li>
                            <li style="margin-bottom: 12px;">
                                <b>Data Analytics Projects:</b><br>
                                Conducted visual exploratory data analysis (EDA), correlation studies, and outliers cleaning.
                            </li>
                            <li style="margin-bottom: 12px;">
                                <b>Machine Learning Projects:</b><br>
                                Engineered pipeline transformers, evaluated classification matrix models, and designed custom ROC indicators.
                            </li>
                        </ul>
                    </div>
                ...
                <!-- Custom Grid responsiveness media rule -->
                <style>
...
# ================= PAGE: CONTACT =================
    ...
    import textwrap
    # 1. Custom Styling (Separated to avoid f-string brace doubling issues)
    st.markdown(
        textwrap.dedent(
            """
            <style>
            ...
            .profile-card-premium:hover {
                ...
                box-shadow: 0 15px 35px var(--accent-glow), var(--shadow);
            }
            ...
            .profile-card-premium:hover .profile-avatar-img {
            ...
            .social-card-premium:hover {
                ...
                box-shadow: 0 20px 40px var(--accent-glow), var(--shadow);
            }
            ...
            .social-card-premium:hover .social-icon-wrapper {
            ...
            .dark-theme .github-card .social-icon-wrapper {
                color: #f3f4f6;
                background: rgba(243, 244, 246, 0.08);
            }
            
            .email-card .social-icon-wrapper {
                color: #ea4335;
            ...
            .dark-theme .github-btn:hover {
                background: #e5e7eb;
                box-shadow: 0 5px 15px rgba(243, 244, 246, 0.4);
            }
            ...
            .quick-btn.linkedin-qb .icon {
                color: #0077b5;
            }
            .quick-btn.github-qb .icon {
                color: #24292e;
            }
            .dark-theme .quick-btn.github-qb .icon {
                color: #f3f4f6;
            }
            .quick-btn.email-qb .icon {
                color: #ea4335;
            }
            </style>
            """
    ...
    # 2. Convert Developer Avatar to Base64 for inline HTML rendering
    base64_avatar = load_base64_avatar()

    # 3. HTML Render Content
    st.markdown(
        textwrap.dedent(
            f"""
            <div class="fade-in-section">
                ...
                <div class="contact-hero">
                    <h1 style="font-size: 2.8rem; margin: 0 0 10px 0;">📬 Contact Me</h1>
                    <p style="font-size: 1.15rem; max-width: 750px; margin: 0 auto; color: var(--text-secondary); line-height: 1.5;">
                        Let's connect and collaborate on Data Analytics, Machine Learning, AI and Software Development projects.
                    </p>
                </div>
                ...
                <div class="profile-card-premium">
                    <div class="profile-avatar-container">
                        <img src="{base64_avatar}" class="profile-avatar-img" alt="Ankit Yadav Portrait">
                    </div>
                    <div class="profile-details">
                        <h2>Ankit Yadav</h2>
                        <div class="role-text">💼 Data Analytics | Machine Learning | AI Enthusiast</div>
                        
                        <div class="info-grid">
                            <div class="info-item">
                                <span class="icon">👤</span>
                                <span><strong>Full Name:</strong> Ankit Yadav</span>
                            </div>
                            <div class="info-item">
                                <span class="icon">📍</span>
                            ...
                            <div class="info-item">
                                <span class="icon">📧</span>
                                <span><strong>Email:</strong> adityayadav10533@gmail.com</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="social-grid">
                    ...
                    <!-- LinkedIn Card -->
                    <div class="social-card-premium linkedin-card">
                        <div>
                            <div class="social-icon-wrapper">🔗</div>
                            <div class="social-title">LinkedIn</div>
                            <div class="social-desc">Connect with me on LinkedIn for professional collaborations, industry updates, and career opportunities.</div>
                        </div>
                        <a href="https://www.linkedin.com/in/ankit-yadav-a83094306?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" class="premium-button linkedin-btn">🔗 Visit LinkedIn</a>
                    </div>

                    <!-- GitHub Card -->
                    <div class="social-card-premium github-card">
                        <div>
                            <div class="social-icon-wrapper">💻</div>
                            <div class="social-title">GitHub</div>
                            <div class="social-desc">Explore my repositories, projects, code samples, and open source contributions in AI/ML and software engineering.</div>
                        </div>
                        <a href="https://github.com/AnkitYadav10533" target="_blank" class="premium-button github-btn">💻 View GitHub</a>
                    </div>

                    <!-- Email Card -->
                    <div class="social-card-premium email-card">
                        <div>
                            <div class="social-icon-wrapper">✉️</div>
                            <div class="social-title">Direct Email</div>
                            <div class="social-desc">Reach out directly via email for projects, freelance work, consultation, or technical inquiries.</div>
                        </div>
                        <a href="mailto:adityayadav10533@gmail.com" class="premium-button email-btn">✉️ Send Email</a>
                    </div>

                </div>

                <!-- Bonus Section: Let's Connect Quick Buttons -->
                <div class="connect-heading">🤝 Let's Connect</div>
                <div class="quick-connect-container">
                    <a href="https://www.linkedin.com/in/ankit-yadav-a83094306?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" class="quick-btn linkedin-qb">
                        <span class="icon">🔵</span> <span>LinkedIn</span>
                    </a>
                    <a href="https://github.com/AnkitYadav10533" target="_blank" class="quick-btn github-qb">
                        <span class="icon">⚫</span> <span>GitHub</span>
                    </a>
                    <a href="mailto:adityayadav10533@gmail.com" class="quick-btn email-qb">
                        <span class="icon">🔴</span> <span>Email</span>
                    </a>
                </div>
    ...
    textwrap.dedent(
        ...
        <div style="text-align: center; padding: 30px 0; margin-top: 50px; border-top: 1px solid var(--card-border);">
            <p style="margin: 0; font-size: 13px; color: var(--text-secondary);">
                Designed & Developed by <b>Ankit Yadav</b> with ❤️ using <b>Python • Streamlit • Machine Learning</b>
            </p>
        </div>
        """
    ),
