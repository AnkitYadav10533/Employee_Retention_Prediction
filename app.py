...
# ================= PAGE: DEVELOPER INFO =================
elif st.session_state.page == "👨‍💻 Developer Info":
    import textwrap
    
    # 1. Custom CSS and Keyframes styling
    st.markdown(
        textwrap.dedent(
            """
            <style>
            ...
            .profile-avatar-img-new {
                ...
                background-image: linear-gradient(var(--card-bg), var(--card-bg)), linear-gradient(135deg, #6366f1 0%, #a855f7 50%, #db2777 100%);
            ...
            .profile-details-new h2 {
                margin: 0 0 5px 0 !important;
                font-size: 32px !important;
                font-weight: 800 !important;
            }
            
            .profile-details-new .role-text-new {
                font-size: 17px;
                font-weight: 600;
                color: #818cf8;
                margin: 0 0 15px 0;
            ...
            .profile-details-new .summary-text {
                font-size: 15px;
                line-height: 1.6;
                color: var(--text-secondary);
                margin-bottom: 25px;
            ...
            .grad-btn-new {
                background: linear-gradient(135deg, #6366f1 0%, #a855f7 50%, #db2777 100%);
            ...
            .skill-badge-python { color: #818cf8; border-color: rgba(99, 102, 241, 0.3); }
            .skill-badge-ml { color: #10b981; border-color: rgba(16, 185, 129, 0.3); }
            .skill-badge-da { color: #f59e0b; border-color: rgba(245, 158, 11, 0.3); }
            .skill-badge-sql { color: #38bdf8; border-color: rgba(56, 189, 248, 0.3); }
            .skill-badge-git { color: #f1502f; border-color: rgba(241, 80, 47, 0.3); }
            .skill-badge-github { color: #cbd5e1; border-color: rgba(203, 213, 225, 0.3); }
            .skill-badge-streamlit { color: #ff4b4b; border-color: rgba(255, 75, 75, 0.3); }
            .skill-badge-excel { color: #107c41; border-color: rgba(16, 124, 65, 0.3); }
            .skill-badge-pandas { color: #a78bfa; border-color: rgba(167, 139, 250, 0.3); }
            .skill-badge-numpy { color: #4d77cf; border-color: rgba(77, 119, 207, 0.3); }
            .skill-badge-sklearn { color: #f89939; border-color: rgba(248, 153, 57, 0.3); }
            .skill-badge-matplotlib { color: #38bdf8; border-color: rgba(56, 189, 248, 0.3); }
            .skill-badge-plotly { color: #ec4899; border-color: rgba(236, 72, 153, 0.3); }
            ...
            .project-card-premium-new::after {
                content: '';
                position: absolute;
                bottom: 0;
                left: 0;
            ...
            .project-card-premium-new:hover {
                transform: translateY(-6px);
                box-shadow: 0 15px 30px rgba(99, 102, 241, 0.15), var(--shadow);
                border-color: rgba(99, 102, 241, 0.3);
            }
            
            .project-card-premium-new:hover::after {
                transform: scaleX(1);
            }
    ...
    # 2. Get Profile Photo in Base64
    base64_avatar = load_base64_avatar()

    # 3. HTML Layout Render
    st.markdown(
        textwrap.dedent(
            f"""
            <div class="fade-in-section-new">
                
                <!-- HEADER -->
                <div class="developer-header-section">
                    <h1 style="font-size: 2.8rem; margin: 0 0 10px 0;">👨‍💻 Developer Information</h1>
                    <p style="font-size: 1.15rem; max-width: 750px; margin: 0 auto; color: var(--text-secondary); line-height: 1.5;">
                        Get to know the developer behind this project
                    </p>
                </div>
                ...
                <div class="main-profile-card">
                    ...
                    <div style="display: flex; justify-content: center;">
                        <div class="profile-avatar-container-new">
                            <img src="{base64_avatar}" class="profile-avatar-img-new" alt="Ankit Yadav Profile Portrait">
                        </div>
                    </div>
                    
                    <!-- Right: Developer info details -->
                    <div class="profile-details-new">
                        <h2 class="gradient-text">Ankit Yadav</h2>
                        <div class="role-text-new">Data Analytics | Machine Learning | AI Enthusiast</div>
                        <p class="summary-text">
                            Passionate about transforming data into meaningful insights through Machine Learning and Data Analytics. I enjoy building end-to-end ML applications and continuously learning modern technologies.
                        </p>
                        
                        <div class="details-row-new">
                            <div class="details-item-new">
                                <span class="icon">📍</span>
                                <span>Lucknow, Uttar Pradesh, India</span>
                            </div>
                            <div class="details-item-new">
                                <span class="icon">📧</span>
                                <span>adityayadav10533@gmail.com</span>
                            </div>
                        </div>

                        <div class="btn-group-new">
                            <a href="https://github.com/AnkitYadav10533" target="_blank" class="grad-btn-new">💻 GitHub</a>
                            <a href="https://www.linkedin.com/in/ankit-yadav-a83094306?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" class="grad-btn-new">🔗 LinkedIn</a>
                        </div>
                    </div>
                </div>

                <!-- SECOND SECTION -->
                <div class="sec-layout-grid">
                    
                    <!-- Left: Technical Skills -->
                    <div class="glass-card">
                        <h3 style="margin-top: 0; margin-bottom: 20px;">🛠 Technical Skills</h3>
                        <div style="margin: -4px;">
                            <span class="skill-badge-new skill-badge-python">Python</span>
                            <span class="skill-badge-new skill-badge-ml">Machine Learning</span>
                            <span class="skill-badge-new skill-badge-da">Data Analytics</span>
                            <span class="skill-badge-new skill-badge-sql">SQL</span>
                            <span class="skill-badge-new skill-badge-git">Git</span>
                            <span class="skill-badge-new skill-badge-github">GitHub</span>
                            <span class="skill-badge-new skill-badge-streamlit">Streamlit</span>
                            <span class="skill-badge-new skill-badge-excel">Excel</span>
                            <span class="skill-badge-new skill-badge-pandas">Pandas</span>
                            <span class="skill-badge-new skill-badge-numpy">NumPy</span>
                            <span class="skill-badge-new skill-badge-sklearn">Scikit-learn</span>
                            <span class="skill-badge-new skill-badge-matplotlib">Matplotlib</span>
                            <span class="skill-badge-new skill-badge-plotly">Plotly</span>
                        </div>
                    </div>

                    <!-- Right: About Me -->
                    <div class="glass-card">
                        <h3 style="margin-top: 0; margin-bottom: 20px;">💡 About Me</h3>
                        <ul class="about-list-new">
                            <li>I am a B.Tech Computer Science student at Shri Ramswaroop Memorial College of Engineering & Management (SRMCEM), Lucknow.</li>
                            <li>I am passionate about Data Analytics, Machine Learning, Artificial Intelligence and Python Development.</li>
                            <li>I enjoy solving real-world problems using data and building interactive ML applications.</li>
                            <li>Always eager to learn modern technologies and improve my practical skills.</li>
                        </ul>
                    </div>
                ...
                <div class="projects-layout-grid">
                    ...
                    <!-- Card 1: Employee Retention Prediction -->
                    <div class="project-card-premium-new">
                        <div>
                            <div class="project-icon-new">🧠</div>
                            <div class="project-name-new">Employee Retention Prediction</div>
                            <div class="project-desc-new">Machine Learning project predicting employee departure risk using a trained Logistic Regression pipeline.</div>
                        </div>
                        <div class="project-meta-new">
                            <span class="project-meta-badge">86% Accuracy</span>
                            <span class="project-meta-badge">Streamlit Deployment</span>
                        </div>
                    </div>

                    <!-- Card 2: Data Analytics Projects -->
                    <div class="project-card-premium-new">
                        <div>
                            <div class="project-icon-new">📈</div>
                            <div class="project-name-new">Data Analytics Projects</div>
                            <div class="project-desc-new">Comprehensive database audits, visual statistics, and data cleaning routines.</div>
                        </div>
                        <div class="project-meta-new">
                            <span class="project-meta-badge">EDA</span>
                            <span class="project-meta-badge">Visualization</span>
                            <span class="project-meta-badge">Dashboards</span>
                        </div>
                    </div>

                    <!-- Card 3: Machine Learning Projects -->
                    <div class="project-card-premium-new">
                        <div>
                            <div class="project-icon-new">🤖</div>
                            <div class="project-name-new">Machine Learning Projects</div>
                            <div class="project-desc-new">Deployable predictive analytics models trained across multiple dataset domains.</div>
                        </div>
                        <div class="project-meta-new">
                            <span class="project-meta-badge">Classification</span>
                            <span class="project-meta-badge">Regression</span>
                            <span class="project-meta-badge">Prediction Models</span>
                        </div>
                    </div>
